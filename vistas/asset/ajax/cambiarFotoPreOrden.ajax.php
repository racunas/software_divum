...
if (isset($_FILES["imagenPreOrden"])){ //SÍ EXISTEN IMAGENES EN EL FORMULARIO, LAS AGREGAMOS AL SERVIDOR
    ...
    imagejpeg($manejadorDeDestino, $src);
   	...
   	$respuesta = modeloPerfil::mdlActualizarFotoPreOrden($idUsuario,$nombreCompleto); //RETORNA FALSE EN CASO DE QUE NO SE HAYA INSERTADO EL NOMBRE DE LA IMAGEN, Y RETORNA TRUE EN CASO DE QUE HAYA INSERTADO EL NOMBRE DE LA IMAGEN
